...
use Topxia\WebBundle\Controller;

class HomeworkFileManageController extends \Topxia\WebBundle\Controller\BaseController
{
    ...
    public function indexAction(Request $request, $id)
    {
        ...
        return $this->render('HomeworkBundle:CourseFileManage:index.html.twig', array(
            'type' => $type,
            'course' => $course,
            'courseLessons' => $files,
    ...
    public function showAction(Request $request, $id, $fileId)
    {
        ...
        if ($file['targetType'] == 'courselesson') {
            return $this->forward('HomeworkBundle:CourseLesson:file', array('fileId' => $file['id'], 'isDownload' => true));
    ...
    public function uploadCourseFilesAction(Request $request, $id, $targetType)
    {
        ...
        return $this->render('HomeworkBundle:CourseFileManage:modal-upload-course-files.html.twig', array(
            'course' => $course,
            'storageSetting' => $storageSetting,
    ...
    public function batchUploadCourseFilesAction(Request $request, $id, $targetType)
    {
        ...
        return $this->render('HomeworkBundle:CourseFileManage:batch-upload.html.twig', array(
            'course' => $course,
            'storageSetting' => $storageSetting,
            'targetType' => $targetType,
            'targetId'=>$id,
